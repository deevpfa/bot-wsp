...
export function FeaturesSectionDemo() {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3  relative z-10  max-w-7xl 2xl:max-w-[100rem] mx-auto">
...
const Feature = ({
    ...
    return (
        <div
            className={cn(
                "flex flex-col px-4 lg:px-0 border-colors-neutral-600 lg:border-r-[0.2px] py-6 lg:py-10 relative group/feature text-white",
                (index === 0 || index === 3) && "lg:border-l-[0.2px] text-white",
                index < 3 && "lg:border-b-[0.2px] text-white"
            )}
        >
            {index < 3 && (
                <div className="opacity-0 lg:group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-primary-100 to-transparent pointer-events-none" />
            )}
            {index >= 3 && (
                <div className="opacity-0 lg:group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-primary-100 to-transparent pointer-events-none" />
            )}
