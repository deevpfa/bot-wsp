...
const Feature = ({
    ...
    return (
        ...
        >
            {index < 3 && (
                <div className="opacity-0 lg:group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-primary-700 to-transparent pointer-events-none" />
            )}
            {index >= 3 && (
                <div className="opacity-0 lg:group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-primary-700 to-transparent pointer-events-none" />
            )}
