...
const navigation = {
    ...
    social: [
        ...
        {
            name: 'Instagram',
            href: "https://www.instagram.com/demesc_ok/",
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
            ...
            <div className="mx-auto max-w-7xl 2xl:max-w-[100rem] overflow-hidden px-6  lg:px-8">
                ...
                <div className=" flex justify-center space-x-10">
                    {navigation.social.map((item) => (
                        <a target="_blank" key={item.name} href={item.href} className="text-gray-400 cursor-pointer hover:text-gray-500">
                ...
                <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                    &copy; 2024 Demesc, Inc. All rights reserved.
                </p>
            </div>
        </footer>
    )
